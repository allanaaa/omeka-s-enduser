---
title: CSV Import - Items
---
Before you begin your import, be sure that you have prepared your csv file following the instructions. 
...
Once you click next, a new page will load with tabs for mapping the data and with basic and advanced settings. 
